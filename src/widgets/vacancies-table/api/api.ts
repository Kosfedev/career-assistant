...
import { TVacanciesResponse, TVacancyStatus, useGetHHVacancies } from '@/entities/vacancies';
...
export const useGetVacancies = () => {
  ...
  const status = (EVacanciesTabs[params.tab as keyof typeof EVacanciesTabs] ?? 0) as TVacancyStatus;
